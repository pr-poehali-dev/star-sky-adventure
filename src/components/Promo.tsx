    ...
    >
      <div className="fixed top-[-10vh] left-0 h-[120vh] w-full">
        <motion.div style={{ y }} className="relative w-full h-full">
          <img
            src="/images/desk.png"
            alt="Уютная закусочная"
            className="w-full h-full object-cover"
            onError={(e) => {
              (e.target as HTMLImageElement).src = "/images/spiral-circles.jpg";
            }}
          />
      ...
      <p className="absolute bottom-12 right-6 text-white text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-3xl z-10">
        С раннего утра до позднего вечера — горячий завтрак, обед и ужин для водителей и путешественников.
      </p>
    </div>
  );
}
